...
# We know the last tip ends with `... No seas cruel contigo mismo.", imagen: "assets/images/exprecionsedraco/pensativo.png" }\n  ];`
content = re.sub(r'\},?\s*\{[^}]*No seas cruel contigo mismo[^}]*\}\s*\];', lambda m: m.group(0).replace('];', new_tips), content)

with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated tips and timing")
